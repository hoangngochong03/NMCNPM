<?php
  ...
  * Slug: outwit-lite/header-transparent
...
<div class="wp-block-group alignfull transparent-header">
	<!-- wp:group {"align":"full","className":"header header-with-cart","layout":{"inherit":true,"type":"constrained"}} -->
	<div class="wp-block-group alignfull header header-with-cart">
		...
		<div class="wp-block-group alignfull">
			...
			<div class="wp-block-group site-section">
				<!-- wp:group {"className":"site-title-section","layout":{"type":"flex","orientation":"vertical","justifyContent":"center"}}} -->
